  ...
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="card">
        ...
        <div class="card-body">
          <form method="POST" action="{{ route('teacher.courses.update', $course->id) }}" novalidate id="form">
            @csrf
            @method('PUT')
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <input id="title" type="title" class="form-control @error('title') is-invalid @enderror" name="title"
                  value="{{ $course->title }}" required autocomplete="title" autofocus>
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <textarea id="description" type="description"
                  ...
                  autocomplete="current-description">{{ $course->description }}</textarea>
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                ...
                <span><i>Leave empty if you do not want to change it</i></span>
              </div>
            </div>
